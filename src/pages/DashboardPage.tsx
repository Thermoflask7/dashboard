...
//transformacion cantidad por categoria
...
//transformacion dispercion precio vs calificacion
const scatterData = useMemo(
  () => filtered.map((p) => ({ price: p.price, rating: p.rating, name: p.title })),
  [filtered]
);

//transformacion 3, precio promedio por categoria
